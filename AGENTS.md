...
| Memory accounting and budgets | `include/clink/runtime/memory_budget.hpp`, `keyed_memory_account.hpp`, `memory_size.hpp`, `arrow_memory_pool.hpp`, `src/runtime/memory_size.cpp` | `docs/internals/memory-management.md` |
