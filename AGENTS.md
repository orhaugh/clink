...
| Memory accounting and budgets | `include/clink/runtime/memory_budget.hpp`, `keyed_memory_account.hpp`, `memory_size.hpp`, `arrow_memory_pool.hpp`, `src/runtime/memory_size.cpp`; SQL working maps: `include/clink/sql/working_set.hpp`; SQL scratch spill: `include/clink/sql/spill_store.hpp`, `src/sql/spill_store.cpp`; SQL TTL: `include/clink/sql/state_ttl.hpp` | `docs/internals/memory-management.md` |
