...
| [Memory budgets](memory-management.md) | Shared tracked-memory budgets, covered state/queue/checkpoint owners, blocking-exchange and SQL GROUP BY spilling, TTL indexes, failure behaviour and allocation coverage limits. |
