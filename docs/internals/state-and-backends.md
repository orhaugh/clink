...
windows split panes and sessions; join buffers split rows. Null-aware joins also
store exact-key probes and cross-key null entries individually. Null probes and wildcard
