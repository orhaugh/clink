...
// derivative). Phase 27c surfaces the StateVersionMap to operators
// without a running JM: read the file, decode the Arrow IPC stream,
// print the (op_id, state_type, version) tuples plus a row count.
//
