...
// Field descriptor, ArrowFields<T> and HasArrowFields live in
// clink/core/fields.hpp (Arrow-free; included above).
...
// The CLINK_ARROW_FIELDS macro lives in clink/core/fields.hpp.
