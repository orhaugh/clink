// Minimal HTTP/1.1 client used by the coordinator to proxy /api/v1/workers/:id/*
// requests through to the target worker's HTTP server. Same pimpl shape
...
public:
    ...
    // (clink_submit_sql -> coordinator JobGraphSpec submission).
