 ...
 *   BENCH_CHECKPOINT_DIR (default /tmp/flink-inproc-ckpts)
 */
public final class InProcPipeline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String ckptDir =
                System.getenv().getOrDefault("BENCH_CHECKPOINT_DIR", "/tmp/flink-inproc-ckpts");
        ...
        env.execute("flink-inproc-pipeline");
    }
}
