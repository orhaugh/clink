-- Nexmark q1 on flink, KAFKA-SINK sink variant. Currency conversion. Per-
...
CREATE TABLE bid (
  ...
  'properties.group.id' = 'flink-q1-bid',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json',
  'json.ignore-parse-errors' = 'false'
);
CREATE TABLE sink_q1 (`auction` BIGINT, `bidder` BIGINT, `price` DOUBLE, `datetime` BIGINT) WITH (
  'connector' = 'kafka',
  'topic' = '__OUT__',
  'properties.bootstrap.servers' = 'kafka:29092',
  'format' = 'json',
