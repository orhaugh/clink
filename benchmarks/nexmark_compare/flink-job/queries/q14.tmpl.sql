-- Nexmark q14 on flink, KAFKA-SINK sink variant. Calculation. Expression
...
CREATE TABLE bid (
  ...
  'properties.group.id' = 'flink-q14-bid',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json',
  'json.ignore-parse-errors' = 'false'
);
CREATE TABLE sink_q14 (`auction` BIGINT, `bidder` BIGINT, `price` DOUBLE, `bidtimetype` STRING) WITH (
  'connector' = 'kafka',
  'topic' = '__OUT__',
  'properties.bootstrap.servers' = 'kafka:29092',
  'format' = 'json',
