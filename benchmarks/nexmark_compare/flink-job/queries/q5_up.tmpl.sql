-- Nexmark q5 on flink, UPSERT-SINK sink variant. Hot items: the single most-
...
CREATE TABLE bid (
  ...
  'properties.group.id' = 'flink-q5up-bid',
  'scan.startup.mode' = 'earliest-offset',
  'format' = 'json',
  'json.ignore-parse-errors' = 'false'
);
CREATE TABLE sink_q5 (`wstart` BIGINT, `auction` BIGINT, `num` BIGINT, PRIMARY KEY (`wstart`) NOT ENFORCED) WITH (
